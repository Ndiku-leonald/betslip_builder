    ...
    def build(self, db: Session, include_unfinished: bool = False) -> list[FeatureRow]:
        ...
        while index < len(fixtures):
            ...
            for fixture in batch:
                ...
                actual = {"home_goals": float(fixture.home_score), "away_goals": float(fixture.away_score), "total": float(fixture.home_score + fixture.away_score), "margin": float(fixture.home_score - fixture.away_score), "home_win": float(fixture.home_score > fixture.away_score), "draw": float(fixture.home_score == fixture.away_score), "away_win": float(fixture.home_score < fixture.away_score), "btts_yes": float(fixture.home_score > 0 and fixture.away_score > 0), "btts_no": float(fixture.home_score == 0 or fixture.away_score == 0)} if fixture.status == "finished" and fixture.home_score is not None and fixture.away_score is not None else None
